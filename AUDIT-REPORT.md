...
**R11. Honesty-note sweep** — add the missing one-to-three-sentence notes on the nine pages listed in §4.3, prioritizing composition-vs-inheritance, and soften the dns caption. **Status:** partially done. The composition-vs-inheritance note and the dns caption softening are already in place. Six pages still need notes: gradient-descent, confusion-matrix, relational-model, classes-and-objects, inheritance, polymorphism.
