...
In the figure, the model side uses hand-authored token probabilities chosen to illustrate this behavior, while the calculation side is computed for real.
