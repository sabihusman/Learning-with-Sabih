...
//
// 14 hand-authored rows. id is unique per row (high cardinality). country has 4
// distinct values with an uneven distribution (US is the most common). plan has
// only 2 values, deliberately skewed so most rows are "free" (this is the
// hot-shard demonstrator: a key with only 2 possible values can never spread
// across more than 2 shards, no matter how many shards exist).
//
...
export const ROWS = [
  { id: 'u-1001', country: 'US', plan: 'free' },
  { id: 'u-1002', country: 'US', plan: 'free' },
  { id: 'u-1003', country: 'US', plan: 'free' },
  { id: 'u-1004', country: 'US', plan: 'pro' },
  { id: 'u-1005', country: 'US', plan: 'free' },
  { id: 'u-1006', country: 'UK', plan: 'free' },
  { id: 'u-1007', country: 'UK', plan: 'free' },
  { id: 'u-1008', country: 'UK', plan: 'pro' },
  { id: 'u-1009', country: 'DE', plan: 'free' },
  { id: 'u-1010', country: 'DE', plan: 'free' },
  { id: 'u-1011', country: 'FR', plan: 'free' },
  { id: 'u-1012', country: 'FR', plan: 'pro' },
  { id: 'u-1013', country: 'US', plan: 'free' },
  { id: 'u-1014', country: 'UK', plan: 'free' },
]
